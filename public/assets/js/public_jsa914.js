...
function initVideo (nn) {
    ...
    $video.each(function () {
        ...
        var video_js_play_btn = $('<div v_id="'+vid+'" class="video_js_play_btn" style="position:absolute;top:0;left:0;right:0;bottom:0;cursor:url(/assets/images/video.png),auto;display:block;z-index:20;"></div>');
...
function chat_online_fun(){
    ...
    var obj = {
        ...
        chat_box: $('<div class="chat_online_box2"><div class="iframe_conceal" style=""></div><div>'),
